...
namespace SimpleEncoding
{
    abstract class SimpleBase
    {
        ...
        public SimpleBase(uint charsCount, string alphabet, char special, Encoding encoding = null, bool parallel = false)
        {
            ...
            uint maxBitsCount = 64, bool base2BitsCount = false)
        {
            int result = 0;
            charsCountInBits = 0;
            int n1 = SimpleBase.LogBase2(charsCount);
            ...
            uint maxBitsCount = 64, uint radix = 2)
        {
            int result = 0;
            charsCountInBits = 0;
            int n0 = SimpleBase.LogBaseN(charsCount, radix);
